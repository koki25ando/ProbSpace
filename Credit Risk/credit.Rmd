...
# feature selection
tic()
for (i in c(2:24, 26:37)){
    nth_list[[i]] = paste0("trial_", i)
    ...
    accuracy_list6[[i]] = confusionMatrix(as.factor(train$Y), as.factor(train$pred))$overall[1]
}
toc()
```
...
nth_list[[1]] = NULL
accuracy_list[[25]] = NA
accuracy_list2[[25]] = NA
accuracy_list3[[25]] = NA
accuracy_list4[[25]] = NA
accuracy_list5[[25]] = NA
accuracy_list6[[25]] = NA
accuracy_table = data.frame(trial = do.call(rbind, nth_list), Accuracy = do.call(rbind, accuracy_list), Accuracy2 = do.call(rbind, accuracy_list2),
                            Accuracy3 = do.call(rbind, accuracy_list3), Accuracy4 = do.call(rbind, accuracy_list4))
```
...
```{r}
credit[, c(8:12, 17, 31, 34)] %>% 
  head
```

past, youth*married, retired, Bill5
...
11: 0.9927407
12: 0.9932593 
13: 0.9938148 (46.617 sec elapsed)
